...
// Builds the reviewable Excel export: one row per submission, the four
// gap scores and overall score up front (so it can be scanned like a
// client list), then every one of the 28 raw 1-5 answers as its own
// column so nothing is hidden behind the computed score. The next phase
