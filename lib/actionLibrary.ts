...
//
// Every entry below is `status: "draft"`, on purpose, the same way Ben's
// own workbook labels its auto-recommendations: "these are drafts to
// react to." Nothing here should reach a client until an F&W advisor
// (Ben, or whoever inherits this) has actually reviewed and edited it.
